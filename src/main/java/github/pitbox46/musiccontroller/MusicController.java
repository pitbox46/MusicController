...
public class MusicController {
    ...
    private void onClientSetup(final FMLClientSetupEvent event) {
        ...
        BackgroundMusicTracks.WORLD_MUSIC = new BackgroundMusicSelector(SoundEvents.MUSIC_GAME, Config.WORLD_MUSIC_RANGE.get().get(0), Config.WORLD_MUSIC_RANGE.get().get(1), false);
